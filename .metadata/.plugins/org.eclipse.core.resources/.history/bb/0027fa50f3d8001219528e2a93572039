...
public class GameClass implements ApplicationListener, InputProcessor {
	...
	public void create() {		
		...
		card2 = new Sprite(region);
		card2.setSize(.08f, .115f);
		card2.setOrigin(card.getWidth()/2, card.getHeight()/2);
		card2.setPosition(-0.1f, 0);
		...
		cardFlipped.setOrigin(cardFlipped.getWidth()/2, cardFlipped.getHeight()/2);
		cardFlipped.setPosition(.1f, 0);
		
		cardFlipped2 = new Sprite(region);
		cardFlipped2.setSize(.08f, .115f);
		cardFlipped2.setPosition(-.45f, 0);
		cardFlipped2.setOrigin(cardFlipped2.getWidth()/2, cardFlipped2.getHeight()/2);
		
		texture = new Texture(Gdx.files.internal("data/cardFlipped3.png"));
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		
		region = new TextureRegion(texture, 0, 0, 80, 115);
		
		cardFlipped3 = new Sprite(region);
		cardFlipped3.setSize(.08f, .115f);
		cardFlipped3.setOrigin(cardFlipped3.getWidth()/2, cardFlipped3.getHeight()/2);
		cardFlipped3.setPosition(-0.1f, 0);
	}
